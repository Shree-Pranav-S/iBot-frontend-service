...
export const RegisterForm: React.FC = () => {
  ...
  return (
    <div className="animate-scaleIn relative overflow-hidden rounded-[24px] border border-[#E6DED2] bg-white px-6 py-5 shadow-[0_30px_80px_-38px_rgba(36,33,29,0.34)] sm:px-8 sm:py-6">
      ...
      <div className="text-center">
        <div className="relative mx-auto grid h-12 w-12 place-items-center rounded-full border border-[#D8C9B5] bg-[#F4E8D6] shadow-inner">
          <span className="grid h-9 w-9 place-items-center rounded-full bg-[#24211D] text-sm font-black text-white shadow-[0_10px_22px_-12px_rgba(36,33,29,0.6)]">
            Ai
          </span>
          <Sparkles className="absolute right-0.5 top-0.5 h-3.5 w-3.5 text-[#B9833F]" />
        </div>
        <h2 className="mt-2 font-display text-xl font-extrabold tracking-[-0.035em] text-[#1F1D1A]">Create Account</h2>
        <p className="mt-1 text-sm text-[#706A61]">Get started with AI interviews</p>
      </div>

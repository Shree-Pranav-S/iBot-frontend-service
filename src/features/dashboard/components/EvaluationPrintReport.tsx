...
export const EvaluationPrintReport: React.FC<EvaluationPrintReportProps> = ({
  ...
  return (
    <article className="evaluation-print-report">
      ...
      <PrintSection number="07" title="Report audit information" pageBreak>
        <dl className="evaluation-print-audit">
          <div>
            <dt>Model</dt>
            <dd>{evaluation.model_name}</dd>
          </div>
          <div>
            <dt>Provider</dt>
            <dd>{evaluation.model_provider}</dd>
          </div>
          <div>
          ...
          <div>
            <dt>Model recommendation</dt>
            <dd>{formatLabel(evaluation.model_recommendation)}</dd>
          </div>
          {evaluation.recommendation_override_reason && (
            <div>
              <dt>Recommendation override</dt>
              <dd>{evaluation.recommendation_override_reason}</dd>
            </div>
          )}
          <div>
            <dt>Transcript fingerprint</dt>
